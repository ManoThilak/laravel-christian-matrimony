<div class="aiz-user-sidenav-wrap pt-4 sticky-top c-scrollbar-light position-relative z-1 shadow-none">
    ...
    <div class="aiz-user-sidenav rounded overflow-hidden">
        ...
        <div class="text-center mb-3 px-3" >
            <a href="{{ route('member_profile', Auth::user()->id) }}" class="btn btn-block btn-soft-primary">{{ translate('View Profile') }}</a>
        </div>
        <div class="text-center mb-3 px-3" >
            <a href="{{ route('profile_settings') }}" class="btn btn-block btn-soft-primary">{{ translate('Edit Profile') }}</a>
        </div>
        <div class="text-center mb-3 px-3" >
            <a href="{{ route('member.listing') }}" class="btn btn-block btn-soft-primary">{{ translate('Search Profile') }}</a>
        </div>
        ...
        <div class="sidemnenu mb-3">
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
               ...
               <!--  <li class="aiz-side-nav-item">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('contact') }}" class="aiz-side-nav-link">
                        <i class="la la-phone aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('My Viewed Profile') }}</span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('contact_requests') }}" class="aiz-side-nav-link">
                        <i class="la la-phone aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Who Viewed My Profile') }}</span>
                    </a>
                </li>
