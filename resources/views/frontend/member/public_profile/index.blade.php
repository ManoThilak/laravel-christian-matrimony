                        ...
                        <div class="accordion aiz-timeline-accordion" id="profile-accordion">
                            ...
                            @if (get_setting('member_present_address_section') == 'on')
                                ...
                                <div class="pb-4 accordion-item">
                                    ...
                                    @php
                                    $view_address = \App\Models\Member::where('user_id', Auth::user()->id)
                                    ->Where('current_package_id', '8')->first();
                                    @endphp
                                                    ...
                                                    <table class="w-100">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                @else
                                                                    <td class="py-1">xx xxx xxx xxx</td>
                                                                @endif
                                                            </tr>
                                                            <tr>
                                                                <td class="py-1 fw-600">
        ...
        function view_contact(id) {
            if (package_validity == 0 || remaining_contact_view < 1) {
                ...
                $("#confirm_modal_content").html("<p class='fs-14'>{{ translate('Remaining Contact View') }}: " +
                    ...
                    " {{ translate('Times') }}</p><small class='text-danger'>{{ translate('**Viewing This Members Contact Information Will Cost  1 From Your Remaining Contact View**') }}</small>"
                    );
        ...
        function express_interest(id) {
            if (package_validity == 0 || remaining_interest < 1) {
                ...
                $("#confirm_modal_content").html("<p class='fs-14'>{{ translate('Remaining Express Interest') }}: " +
                    remaining_interest +
                    " {{ translate('Times') }}</p><small class='text-danger'>{{ translate('**Expressing An Interest Will Cost 1 From Your Remaining Interests**') }}</small>"
                    );
