            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <select class="form-control aiz-selectpicker" name="present_country_id" id="present_country_id" data-live-search="true" required>
                        ...
                        <?php $countries = \App\Models\Country::where('status',0)->get(); ?>
                        @foreach ($countries as $country)
                            <option readonly value="{{$country->id}}" @if($country->id == $present_country_id) selected @endif>{{$country->name}}</option>
                        @endforeach
                    </select>
