                                            ...
                                            <div class="row gutters-5 text-center">
                                                ...
                                                <div class="col">
                                                    ...
                                                    @else
                                                        ...
                                                        class="text-reset c-pointer"
                                                        >
                                                        <i class="las la-phone fs-20 text-primary"></i>
                                                        <span class="d-block fs-10 opacity-60">{{ translate('Phone') }}</span>
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    @php
        ...
        function express_interest(id) {
            if (package_validity == 0 || remaining_interest < 1) {
                ...
                $("#confirm_modal_content").html("<p class='fs-14'>{{ translate('Remaining Express Interest') }}: " +
                    remaining_interest +
                    " {{ translate('Times') }}</p><small class='text-danger'>{{ translate('**An Interest Will Cost 1 From Your Remaining Interests**') }}</small>"
                    );
