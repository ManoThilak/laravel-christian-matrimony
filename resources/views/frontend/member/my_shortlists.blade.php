...
<script type="text/javascript">
    ...
    function express_interest(id)
    {
        if( package_validity == 0 || remaining_interest < 1){
          ...
          $("#confirm_modal_content").html("<p class='fs-14'>{{translate('Remaining Express Interests')}}: "+remaining_interest+" {{translate('Times')}}</p><small class='text-danger'>{{translate('**Expressing An Interest Will Cost 1 From Your Remaining Interests**')}}</small>");
