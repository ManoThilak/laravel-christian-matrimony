        ...
        <div class="row mb-4">
            <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-10 text-center mx-auto">
                <div class="logo mb-4">
                    ...
                    @if (Auth::user()->member->registered == 1) 
                    ...
                    @else
                    <a href="{{ route('packages') }}" class="d-inline-block py-15px">
                        @if(get_setting('footer_logo') != null)
                            <img src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-40px" height="40">
                        @else
                            <img src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-40px" height="40">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="lh-1">
                        ...
                        <p><font color="#fd5366"><span style="font-weight: bolder;">INDIAN CHRISTIAN MATRIMONY</span></font></p>
                        <span>Powered By : <a style="color: rgb(250 0 0);" onmouseover="this.style.color='rgb(250 0 0)'" onmouseout="this.style.color='rgb(250 0 0)'" class="jellysoft" href="https://jellysoft.in" target="_blank">Jellysoft</a></span>
                    </div>
                </div>
...
<div class="aiz-mobile-bottom-nav d-xl-none fixed-bottom bg-white shadow-lg border-top rounded-top" style="box-shadow: 0px -1px 10px rgb(0 0 0 / 15%)!important; ">
    <div class="row align-items-center gutters-5 text-center">
        <div class="col">
            ...
            @else
            <a href="{{ route('packages') }}" class="text-reset d-block flex-grow-1 text-center py-2">
                <i class="las la-home fs-18 opacity-60 {{ areActiveRoutes(['home'],'opacity-100')}}"></i>
                <span class="d-block fs-10 opacity-60 {{ areActiveRoutes(['home'],'opacity-100 fw-600')}}">{{ translate('Home') }}</span>
            </a>
            @endif
        ...
        @if (Auth::check())
            @if(Auth::user()->user_type == 'member')
                <div class="col">
                    <a href="" class="text-reset d-block flex-grow-1 text-center py-2 mobile-side-nav-thumb" data-toggle="class-toggle" data-target="">
                        <span class="d-block mx-auto mb-1 opacity-60">
                            <img src="{{ uploaded_asset(Auth::user()->photo)}}" class="rounded-circle size-20px" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/login.png') }}';">
                        </span>
                        <span class="d-block fs-10 opacity-60">{{ translate('login') }}</span>
                    </a>
                </div>
            @else
                <div class="col">
            ...
            <div class="col">
                <a href="{{ route('login') }}" class="text-reset d-block flex-grow-1 text-center py-2">
                    <span class="d-block mx-auto mb-1 opacity-60 {{ areActiveRoutes(['login'],'opacity-100')}}">
                        <img src="{{ static_asset('assets/img/login.png') }}" class="rounded-circle size-20px">
                    </span>
                    <span class="d-block fs-10 opacity-60 {{ areActiveRoutes(['login'],'opacity-100 fw-600')}}">{{ translate('login') }}</span>
                </a>
            </div>
        @endif
        @if (Auth::check())
...
<a href="https://api.whatsapp.com/send?phone=919443347065&amp;text= Hello INDIAN Christian Matrimony, I visit your website, I need more information." target="_blank" id="Whatsapp">
    <img src="{{ env('APP_URL') . '/public/assets/img/WhatsApp.svg' }}"  alt="whatsapp">
   </a>