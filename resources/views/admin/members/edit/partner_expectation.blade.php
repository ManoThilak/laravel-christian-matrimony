...
<div class="card-body">
    <form action="{{ route('partner_expectations.update', $member->id) }}" method="POST">
        ...
        <div class="form-group row">
            <div class="col-md-6">
                <label for="partner_height">{{translate('Height')}} ({{ translate('In Feet') }})</label>
        ...
        <div class="form-group row">
            ...
            <!-- <div class="col-md-6">
             ...
             <div class="col-md-6">
                    <label for="pertner_complexion">{{translate('Complexion')}}</label>
                    @php $complexion = !empty($member->partner_expectations->complexion) ? $member->partner_expectations->complexion : ""; @endphp
                    <select class="form-control aiz-selectpicker" name="pertner_complexion" >
                      <option value="">{{translate('Select One')}}</option>
