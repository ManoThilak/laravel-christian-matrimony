                ...
                <table class="table aiz-table mb-0">
                    <thead>
                        <tr>
                            ...
                            @endphp
                            @endforeach
                            @if($registered_header  == 1)
                            <th data-breakpoints="md">{{translate('Registration Fees')}}</th>
                            @endif
                    ...
                    <tbody>
                        @foreach($members as $key => $member)
                            <tr>
                                ...
                                @php 
                                    $registered_status = \App\Models\Member::where('user_id',$member->id)->first(); 
                                @endphp
                                @if($registered_status->registered == 1)
                                <td> <span class="badge badge-inline badge-success">{{translate('PAID')}}</span></td>
                                @else
                                <td> <span class="badge badge-inline badge-danger">{{translate('UN PAID')}}</span></td>
                                @endif
                                @endif
                               
                                <!-- <td> <span class="badge badge-inline badge-danger">{{translate('PAID')}}</span></td> -->
                                <td class="text-right">
