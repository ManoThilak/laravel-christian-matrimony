...
class MemberController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($user->save()){
            ...
            $member->registered                 = 1;
            $member->registered_amount          = $package->price;
    ...
    public function basic_info_update(Request $request, $id)
    {
        ...
        $this->messages = [
            ...
            'phone.digits'                  => translate('Maximum 10 numbers'),
            //'phone.min'              => translate('Minimum 10 numbers'),
    ...
    //  $member->package_validity           = date('Y-m-d', strtotime($member->package_validity. ' +'. $package->validity .'days'));
        $member->package_validity           = date('Y-m-d', strtotime(now()->format('Y-m-d'). ' +'. $package->validity .'days'));
        $membership                         = $package->id == 1 ? 1 : 2;
