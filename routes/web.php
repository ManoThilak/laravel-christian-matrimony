...
Route::get('/packages_nonuser', 'PackageController@select_package_nonuser')->name('packages_nonuser');
...
Route::group(['middleware' => ['member','verified']], function(){
    ...
    Route::get('/interest/contact', 'ExpressInterestController@contact')->name('contact');
    Route::get('/interest/contact_requests', 'ExpressInterestController@contact_requests')->name('contact_requests');
